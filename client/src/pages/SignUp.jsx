...
export default function SignUp() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmitMessage('Account created successfully! Welcome to BoboEstate!');
  ...
  const ErrorAnimation = () => (
    <div className="flex items-center justify-center py-2">
      <div className="flex items-center space-x-2">
        ...
        <span className="text-red-600 text-sm font-medium">Registration Failed</span>
      </div>
    </div>
  );
        ...
        <div className="w-full max-w-xs sm:max-w-md">
          ...
          {submitStatus === 'success' && (
            <div className="mb-4 bg-green-50 border border-green-200 rounded-xl p-4">
              ...
              <p className="text-green-600 text-center text-xs mt-1">You can now sign in to your account</p>
            </div>
          )}
          ...
          {submitStatus === 'error' && (
            <div className="mb-4 bg-red-50 border border-red-200 rounded-xl p-4">
              ...
              <p className="text-red-600 text-xs mt-2">Please check your information and try again</p>
            </div>
          )}
