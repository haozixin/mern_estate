      ...
      <div className="relative flex items-center justify-center px-2 sm:px-4 z-10">
        <div className="w-full max-w-xs sm:max-w-md">
          ...
          <div className="text-center mb-4 sm:mb-8">
            ...
            <h1 className="text-xl sm:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Create Account</h1>
            <p className="text-xs sm:text-base text-gray-600">Join us and start your real estate journey</p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-xl sm:rounded-3xl shadow-2xl p-3 sm:p-6 lg:p-8 border border-white/20">
            <div className="space-y-3 sm:space-y-6">
              ...
              <div className="space-y-1 sm:space-y-2">
                <label htmlFor="username" className="text-xs sm:text-sm font-medium text-gray-700 block">
                  Username
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-8 sm:pl-10 pr-3 sm:pr-4 py-2 sm:py-3 border-2 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 text-sm sm:text-base ${
              ...
              <div className="space-y-1 sm:space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full pl-8 sm:pl-10 pr-9 sm:pr-12 py-2 sm:py-3 border-2 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 text-sm sm:text-base ${
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 pr-2.5 sm:pr-3 flex items-center hover:text-blue-600 transition-colors"
                  >
                    {showPassword ? (
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-2 sm:py-3 px-4 rounded-lg sm:rounded-xl font-medium hover:from-blue-700 hover:to-indigo-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transform transition-all duration-200 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg text-sm sm:text-base"
              >
                {isLoading ? (
